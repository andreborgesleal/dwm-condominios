...
namespace DWM.Models.Persistence
{
    ...
    public class ListViewArquivoAPI : ListViewModelLocal<ArquivoViewModel>
    {
        #region Métodos da classe ListViewRepository
        public override IEnumerable<ArquivoViewModel> Bind(int? index, int pageSize = 50, params object[] param)
        {
            ...
            int _CondominoID = (int)param[2];
            int _GrupoCondominoID = (int?)param[3] ?? 0;
            string _Nome = (string)param[4];
