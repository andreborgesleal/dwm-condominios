...
{
    public class LimpezaInspecaoItemController : DwmRootController<LimpezaInspecaoItemViewModel, LimpezaInspecaoItemModel, ApplicationContext>
    {
        #region Inheritance
        ...
        public ActionResult ListParam(int? index, int? pageSize = 50, string descricao = null)
        {
            ...
            if (ViewBag.ValidateRequest)
            {
                ListViewLimpezaInspecaoItem l = new ListViewLimpezaInspecaoItem();
        ...
        {
            return _Edit(new LimpezaInspecaoItemViewModel() { LimpezaRequisitoID = limpezaRequisitoID, LimpezaInspecaoID = limpezaInspecaoID });
        }
        #endregion
        ...
        {
            return Edit(limpezaInspecaoID, limpezaRequisitoID);
        }
        #endregion
    }
}