...
{
    public class EmpregadoController : DwmRootController<EmpregadoViewModel, EmpregadoModel, ApplicationContext>
    {
        #region Inheritance
        ...
        public ActionResult ListParam(int? index, int? pageSize = 50, string descricao = null)
        {
            ...
            if (ViewBag.ValidateRequest)
            {
                ListViewEmpregado l = new ListViewEmpregado();
        ...
        {
            return _Edit(new EmpregadoViewModel() { EmpregadoID = empregadoID });
        }
        #endregion
