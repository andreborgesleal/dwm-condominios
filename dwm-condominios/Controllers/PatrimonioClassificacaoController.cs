...
{
    public class PatrimonioClassificacaoController : DwmRootController<PatrimonioClassificacaoViewModel, PatrimonioClassificacaoModel, ApplicationContext>
    {
        #region Inheritance
        ...
        #region Edit
        [AuthorizeFilter]
        public ActionResult Edit(int patrimonioClassificacaoID)
        {
            return _Edit(new PatrimonioClassificacaoViewModel() { PatrimonioClassificacaoID = patrimonioClassificacaoID });
        }
        #endregion

        #region Delete
        [AuthorizeFilter]
        public ActionResult Delete(int patrimonioClassificacaoID)
        {
            return Edit(patrimonioClassificacaoID);
        }
        #endregion
    }
}