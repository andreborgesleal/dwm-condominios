...
namespace DWM.Controllers
{
    public class DocumentosController : DwmRootController<ArquivoViewModel, ArquivoModel, DWM.Models.Entidades.ApplicationContext>
    {
                                        ...
                                        string Nome = null)
        {
            ...
            if (ViewBag.ValidateRequest)
            {
                ...
                if (SessaoLocal.CondominoID == 0)
                    return this._List(index, pageSize, "Browse", l, _data1, _data2, _EdificacaoID, _UnidadeID, _CondominoID, _GrupoCondominoID, Nome);
                else
                    return this._List(index, pageSize, "Browse", l, _data1, _data2, _EdificacaoID, _UnidadeID, SessaoLocal.CondominoID, _GrupoCondominoID, Nome);
            }
            else
                return View();
        }
        ...
        //#region Create
        //public override void BeforeCreate(ref ArquivoViewModel value, FormCollection collection)
        //{
