...
{
    public class CredorLicitacaoController : DwmRootController<CredorLicitacaoViewModel, CredorLicitacaoModel, ApplicationContext>
    {
        #region Inheritance
        ...
        public ActionResult ListParam(int? index, int? pageSize = 50, string descricao = null)
        {
            ...
            if (ViewBag.ValidateRequest)
            {
                ListViewCredorLicitacao l = new ListViewCredorLicitacao();
        ...
        #region Edit
        [AuthorizeFilter]
        public ActionResult Edit(int LicitacaoID)
        {
            return _Edit(new CredorLicitacaoViewModel() { LicitacaoID = LicitacaoID });
        }
        #endregion

        #region Delete
        [AuthorizeFilter]
        public ActionResult Delete(int LicitacaoID)
        {
            return Edit(LicitacaoID);
        }
        #endregion
    }
}