...
{
    public class EspacoComumController : DwmRootController<EspacoComumViewModel, EspacoComumModel, ApplicationContext>
    {
        #region Inheritance
        ...
        public ActionResult ListParam(int? index, int? pageSize = 50, string descricao = null)
        {
            ...
            if (ViewBag.ValidateRequest)
            {
                ListViewEspacoComum l = new ListViewEspacoComum();
        ...
        #region Edit
        [AuthorizeFilter]
        public ActionResult Edit(int EspacoID)
        {
            return _Edit(new EspacoComumViewModel() { EspacoID = EspacoID });
        }
        #endregion

        #region Delete
        [AuthorizeFilter]
        public ActionResult Delete(int EspacoID)
        {
            return Edit(EspacoID);
        }
        #endregion
    }
}